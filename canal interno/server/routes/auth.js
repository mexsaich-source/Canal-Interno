...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        if (users.length === 0) {
            // For first time setup / dev, if no users exist, allow creating admin
            // This is a TEMPORARY convenience for the user to get started without running SQL
            // In a real app we'd pre-seed or have a registration CLI.
            // Let's check if the table is empty and if so, create the user.
